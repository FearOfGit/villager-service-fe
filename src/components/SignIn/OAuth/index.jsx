...
const authGoogle = 'https://devwinter.com/oauth2/authorization/google';
const authNaver = 'https://devwinter.com/oauth2/authorization/naver';
const authKakao = 'https://devwinter.com/oauth2/authorization/kakao';

function LoginButtonGoogle () {
  return(
    <Link href={authGoogle} rel="noopener noreferrer" target="_blank">
      <ButtonGoogle>
        <GoogleLogoBox>
          <GoogleLogo />
        </GoogleLogoBox>
...
function LoginButtonNaver () {
  return(
    <Link href={authNaver} rel="noopener noreferrer" target="_blank">
      <ButtonNaver>
        <NaverLogo />
...
function LoginButtonKakao () {
  return(
    <Link href={authKakao} rel="noopener noreferrer" target="_blank">
      <ButtonKakao>
        <KakaoLogo />
